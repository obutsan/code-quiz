		...
		<Row className="d-flex align-items-center">
			<Col xs={12} md={4} className="text-center mb-3">
				...
				<ul className="list-unstyled d-flex justify-content-center gap-4 align-items-center">
					<li>
						<a href="/about" className="fw-light link-light link-offset-3 link-underline-opacity-25 link-underline-opacity-100-hover">
							About us
						</a>
					</li>
					<li>
						<a href="/contact" className="fw-light link-light link-offset-3 link-underline-opacity-25 link-underline-opacity-100-hover">
							Contact us
						</a>
					</li>
				</ul>
			...
			<Col xs={12} md={4} className="text-center d-flex flex-column align-items-center">
				<img src={logo} alt="Logo" className="footer-logo mb-2" style={{ maxWidth: '50px', maxHeight: '50px' }} />
