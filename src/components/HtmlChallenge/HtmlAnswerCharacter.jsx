...
const HtmlAnswerCharacter = ({ alertMessage }) => {
  const getImageId = () => {
    switch (alertMessage) {
      case "Correct!":
        return "sessionWinCharacter";
      case "Wrong!":
        return "sessionLoseCharacter";
      case "Start!":
        return "readyCharacter";
      case "Game Over!":
        return "gameOverCharacter";
      case "Well done! Hurray!":
        return "gameWonCharacter";
      default:
        return null;
    }
  };
  ...
  return (
    <div>
      {character && (
        <img
          className="d-block border-2 rounded img-fluid"
          style={{ maxWidth: "8em" }}
          src={character.image}
          alt={character.id}
        />
