...
export const failNotification = () => {
  toast((t) => (
    <div className="card mb-3 notification" style={{ maxWidth: '540px', ...cardStyles }}>
      <div className="row g-0">
        ...
        <div className="col-md-4 d-flex flex-column justify-content-center">
          <Nav.Link href="/" className="btn btn-danger mb-2" style={buttonStyles}>
            Exit Game
          </Nav.Link>
          <Nav.Link
            href="/level1"
