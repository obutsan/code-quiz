  ...
  return (
    <Container>
      <Row>
        ...
        >
          <h2>
            Explore <span className="text-warning">GitHub repositories</span> in
            your programming language of&nbsp;choice.
          </h2>
          <p className="fs-5 my-3 py-3">
            <span className="text-warning">GitHub Explorer</span> allows you to
            explore the most popular GitHub repositories based on the
      ...
      <Row>
        <Col md={9} className="my-3 d-flex flex-column justify-content-center">
          <p className="fs-5">
            Select a <strong>language</strong>, enter <strong>keywords</strong>{" "}
            if you are looking for code related to a specific feature or topic,
            and find relevant repositories with ease.
          </p>
          <p className="fs-5">
            The <strong>top 20 repositories</strong> will be listed in order of
            their star ranking.
          </p>
        </Col>
        <Col
        ...
        >
          <Image
            src={octocat}
            alt="Knight working at a computer desk"
      ...
      {/* Explore Button */}
      <Button
        className="btn gradient-bg-orange rounded-pill px-4 fs-5"
        onClick={exploreRepos}
      >
        Explore
      </Button>
