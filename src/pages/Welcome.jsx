...
const Welcome = () => {
    ...
    <Row>
          ...
          <Image className="ps-md-5" src={fightGif} alt="CodeQuest background" fluid rounded style={{ maxHeight: '70vh', height: 'auto' }} />
        </Col>
        <Col md="6" className="order-md-1 d-flex flex-column justify-content-center">
            <h1 className="mt-4 text-responsive" style={{ height: '200px', overflow: 'hidden' }}>
